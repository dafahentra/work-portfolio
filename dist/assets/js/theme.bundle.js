...
/*!**************************************************!*\
  !*** ./src/assets/js/components/avatar-webgl.js ***!
  \**************************************************/
/*! exports provided: avatarReveal */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "avatarReveal", function() { return avatarReveal; });
...
class AvatarHoverMaskReveal {
  ...
  init() {
    ...
    this.camera = new three_build_three_min_js__WEBPACK_IMPORTED_MODULE_0__["OrthographicCamera"](
      width / -2, width / 2,
      height / 2, height / -2,
      0.1, 10
    );
    ...
    // Load textures
    const loader = new three_build_three_min_js__WEBPACK_IMPORTED_MODULE_0__["TextureLoader"]();
    ...
    [texA, texB].forEach(tex => {
      tex.minFilter = three_build_three_min_js__WEBPACK_IMPORTED_MODULE_0__["LinearFilter"];
      tex.magFilter = three_build_three_min_js__WEBPACK_IMPORTED_MODULE_0__["LinearFilter"];
      tex.format = three_build_three_min_js__WEBPACK_IMPORTED_MODULE_0__["RGBFormat"];
    });

    // Create shader material
    this.material = new three_build_three_min_js__WEBPACK_IMPORTED_MODULE_0__["ShaderMaterial"]({
      vertexShader,
      fragmentShader,
      uniforms: {
        uTextureA: { value: texA },
        uTextureB: { value: texB },
        uMouse: { value: new three_build_three_min_js__WEBPACK_IMPORTED_MODULE_0__["Vector2"](0.5, 0.5) },
        ...
        uImageSizeA: { value: new three_build_three_min_js__WEBPACK_IMPORTED_MODULE_0__["Vector2"](1, 1) },
        uImageSizeB: { value: new three_build_three_min_js__WEBPACK_IMPORTED_MODULE_0__["Vector2"](1, 1) },
    ...
    const geometry = new three_build_three_min_js__WEBPACK_IMPORTED_MODULE_0__["PlaneGeometry"](width, height);
    this.mesh = new three_build_three_min_js__WEBPACK_IMPORTED_MODULE_0__["Mesh"](geometry, this.material);
    ...
    this._onMouseEnter = (e) => {
      ...
      this._hoverTween = gsap__WEBPACK_IMPORTED_MODULE_1__["gsap"].to(this.material.uniforms.uHover, {
        value: 1,
        duration: 0.5,
        ease: 'power2.out'
      });
  ...
  _handleResize() {
    ...
    if (this.mesh) {
      ...
      const newGeom = new three_build_three_min_js__WEBPACK_IMPORTED_MODULE_0__["PlaneGeometry"](width, height);
      this.mesh = new three_build_three_min_js__WEBPACK_IMPORTED_MODULE_0__["Mesh"](newGeom, this.material);
      this.scene.add(this.mesh);
    }
